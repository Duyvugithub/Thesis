...
\begin{document}
    \begin{figure}[h]
        \begin{floatrow}
        \ffigbox{\includegraphics[scale = 0.1]{images/Proposal/logo.png}}  
        {%
    ...
    \centering
        ...
        \textbf{\begin{tabular}[c]{@{}c@{}}\textit{TP. Hồ Chí Minh, ngày 2 tháng 4 năm 2022}\\NHÓM SINH VIÊN THỰC HIỆN\\\textit{(Ký và ghi rõ họ tên})\end{tabular}}
        \end{tabular}
        
        \begin{tabular}{p{8cm}p{7cm}}
        &\textbf{\begin{tabular}[c]{@{}c@{}}\includegraphics[width=0.3\textwidth]{images/Proposal/duyvu.jpg}\\\end{tabular}}\\
        
        \textbf{\begin{tabular}[c]{@{}c@{}}TRẦN TRUNG KIÊN \end{tabular}}& 
        \textbf{\begin{tabular}[c]{c}NGUYỄN DUY VŨ\end{tabular}}\\
        &\textbf{\begin{tabular}[c]{@{}c@{}}\includegraphics[width=0.3\textwidth]{images/Proposal/chieuban.jpg}\\\end{tabular}}\\
        
        \textbf{\begin{tabular}[c]{@{}c@{}}NGUYỄN NGỌC THẢO \end{tabular}}& 
        \textbf{\begin{tabular}[c]{c}NGUYỄN CHIÊU BẢN\end{tabular}}
        \end{tabular}\\
    \end{table}
