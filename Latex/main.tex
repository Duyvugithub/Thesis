...
% ========================================================================================= %
\newcommand{\tenSV}{Nguyễn~Duy~Vũ~-~Nguyễn~Chiêu~Bản} % Dấu ~ là khoảng trắng không được tách (các chữ nối với nhau bằng dấu ~ sẽ nằm cùng 1 dòng
\newcommand{\mssv}{18120264~-~18120283}
\newcommand{\tenKL}{Giải~quyết~vấn~đề~dữ~liệu~bị~thiên~lệch~trong~bài~toán~đề~xuất~sản~phẩm~bằng~mô~hình~học~dựa~trên~độ~đo~IPS. (Solving~the~problem~of~biased~data~in~recommender~system~by~IPS-based~learning~model)} % Chú ý dấu ~ trong tên khóa luận
\newcommand{\tenGVHD}{Th.S.~Trần~Trung~Kiên~-~TS.~Nguyễn~Ngọc~Thảo}
...
\printbibliography[heading=subbibliography, title={Tiếng Anh}, notkeyword=Viet, resetnumbers=6] 
% ===================================================================== %
